...
console.log(`[🛡️ AUTO-MOD] Loaded the Event: Anti-Scam Links`.blue.bold)
client.on('messageCreate', async(message) => {
  ...
  database.forEach((m) => {
    ...
    message.delete()
          ...
          message.member.timeout(300000, `AUTOMOD| Scam Link`)
          message.author.send(`<:Error:930608437665083402> **AUTOMOD | You have been timedout for sending a scam link!**\n> *This doesn't affect you if your Admin!*`)
    }    
  })
})